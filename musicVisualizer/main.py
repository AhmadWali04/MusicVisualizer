...
3. Visualizing palette differences with dual popups
...
def example_1_basic_usage():
    ...
    if feedback_choice == 'y':
        ...
        print("\nSkipping feedback.")
        # Save the model without fine-tuning
        CNN.save_trained_model(
            results['model'],
            config.get_model_path(),
            metadata={
...
def example_3_palette_preview():
    ...
    """
    print("\n" + "="*70)
    print("EXAMPLE 3: Palette Preview with Dual Popups")
    print("="*70)
...
def example_4_standard_coloring():
    ...
    # Step 2: Colorize with original image colors and save
    ...
    # Step 3: Show dominant colors from the template image
    ...
    # Step 4: Show RGB cloud of the template image
...
if __name__ == '__main__':
    ...
    print("  3. Palette visualization (dual popup)")
    print("  4. Standard coloring (original colors, no CNN)")
